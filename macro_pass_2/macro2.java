...
public class macro2
{
        public static void main(String args[])
        {
                ...
                try
                {
                        br=new BufferedReader(new FileReader("Input _macro2 file.txt"));
                        br1=new BufferedReader(new FileReader("mnt_macro2.txt"));
                        br2=new BufferedReader(new FileReader("mdt_macro2.txt"));
